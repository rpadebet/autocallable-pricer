...
> **Status**: v0.3.1 — 66/66 tests passing — Greeks page complete — ready for git + deploy
...
| `app/pages/05_Scenarios.py` | 🔲 Not written (lower priority) | Payoff diagrams, what-if sliders |
